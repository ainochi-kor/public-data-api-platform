import {
  ...
  GetCategoryCodeParam,
  GetCategoryCodeResponse,
  GetAreaBasedListParam,
  GetAreaBasedListResponse,
...
export default class TravalServices {
  ...
  getCategoryCode(params: GetCategoryCodeParam): Promise<{
    response: GetCategoryCodeResponse;
  }> {
    return new Promise(async (resolve, reject) => {
      this.axios
        .get("/categoryCode1", { params })
        .then((res) => {
          resolve(res.data);
        })
        .catch((err: AxiosError) => {
  ...
  getAreaBasedListCode(params: GetAreaBasedListParam): Promise<{
    response: GetAreaBasedListResponse;
  }> {
    return new Promise(async (resolve, reject) => {
      this.axios
        .get("/areaBasedList1", { params })
        .then((res) => {
          resolve(res.data);
        })
        .catch((err: AxiosError) => {
